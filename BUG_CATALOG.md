...
> **SUPERSEDED.** This is the May 15 prior audit. It caught 20 real bugs but
> missed the ship-blockers (broken JA4+ integration, off-by-one SNI, JA4X
> vapor, gitignored test fixtures) and "documented away" things it never
> tested. The current, authoritative review is
> `GHOSTWIRE_AUDIT_2026-06-21.md`, and the fixes for everything below (plus
> the missed ship-blockers) are on branch `fix/audit-2026-06-21`. This file
> is kept for historical context only — do not rely on its status table.
